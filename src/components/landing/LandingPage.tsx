...
/**
 * Marketing landing — primary CTA goes straight to /builder (no auth gate).
 */
  ...
  return (
    <div className="min-h-screen bg-background font-body antialiased overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          >
            ...
            <span>
              Forever<span className="text-primary">Foundry</span>
            </span>
          </button>
          <Link
            href="/builder"
      ...
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden">
        <div className="pointer-events-none absolute -top-24 -left-10 w-72 h-72 rounded-full bg-primary/15 blur-3xl" aria-hidden />
        <div className="pointer-events-none absolute -bottom-32 -right-10 w-80 h-80 rounded-full bg-secondary/20 blur-3xl" aria-hidden />
        <div className="pointer-events-none absolute top-1/3 -right-24 w-64 h-64 rounded-full bg-accent/10 blur-3xl" aria-hidden />
        <div className="container mx-auto px-6 text-center">
          <p className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-8 animate-fade-up">
            ...
            AI-powered wedding sites — live preview in seconds
          </p>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up animation-delay-200">
            One stunning website for every ceremony. Themes, galleries, RSVPs — no ads, no clutter. Start free, no login required.
          </p>
      ...
      <section className="relative py-16 md:py-20 bg-muted/30 overflow-hidden">
        <div className="pointer-events-none absolute -top-24 -right-10 w-72 h-72 rounded-full bg-primary/12 blur-3xl" aria-hidden />
        <div className="pointer-events-none absolute -bottom-24 -left-16 w-80 h-80 rounded-full bg-accent/10 blur-3xl" aria-hidden />
        <div className="container mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: Flower2,
                title: "Made for Indian weddings",
                desc: "Mehendi, Sangeet, Haldi, Wedding, Reception — every event in one place with the right vibe.",
              },
              {
                icon: Palette,
                title: "Beautiful, not generic",
                desc: "Themes and motifs that feel like your wedding, not a template from a dropdown.",
              },
              {
                icon: Shield,
                title: "No ads. Your privacy.",
                desc: "Your site and your guests’ data stay yours. No tracking, no sponsored clutter.",
              },
              {
                icon: Gift,
                title: "Free to start",
                desc: "Create your site with no credit card. Add accounts later when you publish.",
              },
            ].map((item, i) => (
              <div
                key={i}
      ...
      <section id="features" className="relative py-16 md:py-20 overflow-hidden">
        <div className="pointer-events-none absolute -top-32 left-1/2 -translate-x-1/2 w-96 h-96 rounded-full bg-primary/8 blur-3xl" aria-hidden />
        <div className="container mx-auto px-6">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-center text-foreground mb-4">
            ...
            {[
              {
                ...
                desc: "Stunning Indian wedding themes with traditional motifs and modern elegance. Switch anytime.",
              },
              {
                icon: Image,
                title: "Photo galleries",
                desc: "Upload unlimited photos, create albums for each function, and share precious moments with family.",
              },
              {
                icon: Calendar,
                title: "Event management",
                desc: "Manage multiple functions — Mehendi, Sangeet, Haldi, Wedding, Reception — with one dashboard.",
              },
            ].map((feature, i) => (
              <div
                key={i}
      ...
      <section className="relative py-16 md:py-20 bg-muted/30 overflow-hidden">
        <div className="pointer-events-none absolute -top-20 left-0 w-72 h-72 rounded-full bg-secondary/15 blur-3xl" aria-hidden />
        <div className="pointer-events-none absolute -bottom-24 right-0 w-80 h-80 rounded-full bg-primary/12 blur-3xl" aria-hidden />
        <div className="container mx-auto px-6">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-center text-foreground mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              {
                quote:
                  "Finally a wedding website that gets Indian weddings. We had Mehendi, Sangeet, and the main day — everything looked beautiful and our guests actually used it.",
                author: "Ananya & Vikram",
                location: "Mumbai",
              },
              {
                quote: "No ads, no chaos. Just our photos, our events, and our story. Exactly what we wanted.",
                author: "Kavya & Arjun",
                location: "Bangalore",
              },
              {
                quote:
                  "Setup was so easy. Our parents could find the schedule and RSVP without calling us a hundred times.",
                author: "Divya & Rohan",
                location: "Delhi",
              },
            ].map((t, i) => (
            ...
            {[
              {
                step: 1,
                title: "Pick a vibe",
                desc: "Choose a design that matches your wedding. Preview updates live as you type.",
              },
              {
                step: 2,
                title: "Add your story & events",
                desc: "Add dates, venues, and your love story. Our AI drafts copy you can refine.",
              },
              {
                step: 3,
                title: "Share & collect RSVPs",
                desc: "Share one link with guests. They can RSVP and see only what you want them to see.",
              },
            ].map((item) => (
      ...
      <section className="py-16 md:py-24 relative">
        ...
        <div className="container mx-auto px-6 relative text-center">
          <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">Start your wedding website today</h2>
          <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
            Free to create. No login required to try. Publish when you’re ready.
          </p>
          <Link
            href="/builder"
            className="inline-flex px-10 py-4 rounded-full bg-primary text-primary-foreground text-lg font-semibold shadow-lg hover:shadow-xl items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition"
          >
            Build your website for free
            <ChevronRight className="w-5 h-5" />
          </Link>
      ...
      <footer className="border-t border-border py-8 bg-muted/20">
        <div className="container mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <Link href="/builder" className="text-sm text-muted-foreground hover:text-foreground transition">
            Open builder
          </Link>
        </div>
      </footer>
